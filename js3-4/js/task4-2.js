 ...
 *
 * Вариант без bootstrap
 * отдельный label с аттрибутом for
 */
(function task4() {
    ...
    elem.reset();
    elem.setTag('label');
    elem.setAttr(['for=q1v1']);
    elem.setText('Вариант ответа №1');
    elem.setParent(liQuestionVariant);
    elem.createAndAddElement();
    //... Блок Вариант ответа №1
    ...
    nodeClone.querySelector('label').setAttribute('for', 'q1v2');
    ...
    nodeClone.querySelector('label').setAttribute('for', 'q1v3');
